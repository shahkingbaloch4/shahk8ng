...
"""%s
 ...
 - fanspage    : facebook.com/shahdinobaloch15
 - whatsap     : +923175889358
 - github      : github.com/Mark-Zuck
 - script name : Dino (king bakoch Facebook Indonesia)
 - version     : 1.1
...
def menu():
    ...
    if unik == '':
        ...
        os.system("xdg-open https://www.facebook.com/groups/shahdinobaloch15")
    elif unik in['9','09']:
        print(ingfo)
    elif unik in['0','00']:
        print ('')
